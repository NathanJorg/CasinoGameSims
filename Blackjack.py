...
class Blackjack():
    def __init__(self, num_decks=1, bet=1.0, blackjack_pay = 3/2, max_hands=2, hit_on_soft_17=False, double_after_split=True):
    ...
    def dealer_play(self):
        ...
        while True:
            ...
            if dealer_value >= 18:
                break
            elif dealer_value == 17 and not self.hit_on_soft_17:
                break
    ...
    def check_for_splits(self, hand_index, dealer_card):
        ...
        if player_rank in ['2' ,'3'] and dealer_card in [2, 3, 4, 5, 6, 7]:
            return True
        elif player_rank == '4' and dealer_card in [5, 6]:
            return True
        elif player_rank == '6' and dealer_card in [2, 3, 4, 5, 6]:
            return True
        elif player_rank == '7' and dealer_card in [2, 3, 4, 5, 6, 7]:
            return True
        elif player_rank in ['8', 'A']:
            return True
        elif player_rank == '9' and dealer_card in [2, 3, 4, 5, 6, 8, 9]:
            return True
        else:
            return False
    ...
    def optimal_strategy(self):
        ...
        while hand_index < len(self.player_hands):
            ...
            while True:
                ...
                player_value, is_hand_soft = self.hand_value(hand)

                # player stands
                if player_value >= 19 and is_hand_soft:
                    break
                elif player_value == 18 and dealer_value in [2, 3, 4, 5, 6, 7, 8] and is_hand_soft:
                    break
                elif player_value >= 17 and not is_hand_soft:
                    break
                elif player_value in [13, 14, 15, 16] and dealer_value in [2, 3, 4, 5, 6] and not is_hand_soft:
                    break
                elif player_value == 12 and dealer_value in [4, 5, 6] and not is_hand_soft:
                    break
                ...
                #player doubles
                    ...
                    if player_value == 9 and dealer_value in [3, 4, 5, 6] and len(self.player_hands[hand_index]) == 2:
                        self.double_down(hand_index)
                        break
                    elif player_value == 10 and dealer_value in [2, 3, 4, 5, 6, 7, 8, 9] and len(self.player_hands[hand_index]) == 2:
                        self.double_down(hand_index)
                        break
                    elif player_value == 11 and len(self.player_hands[hand_index]) == 2:
                        self.double_down(hand_index)
                        break    
                    else:    
                        self.player_hit(hand_index)       
